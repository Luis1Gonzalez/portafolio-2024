import { gifProjects } from "../data/gifProjectsHome";
...
const Projects = () => {
    ...
    return (
        <div id="projects" className="flex flex-col lg:flex-row gap-5 md:gap-0 p-5 justify-center border border-gray-700/50 w-[100%]">
            ...
            <div className="flex flex-col">
                ...
                <div className="mt-3">
                    <p className="text-end">{lang === 'english' ? 'I have more projects, click' : 'Tengo mas proyectos, has click'}
